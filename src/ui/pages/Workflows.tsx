...
const Workflows: React.FC = () => {
    ...
    const handleCreateWorkflow = async (createVolumes = false) => {
        ...
        try {
            const result = await apiService.executeWorkflow(selectedFile, undefined, createVolumes);
            ...
            // Navigate to the workflow detail page after a brief delay
            // to allow the workflow to be registered in the system
            if (result.workflowId) {
                console.log('Workflow started successfully:', result.workflowId);
                // Small delay to allow workflow to be registered
                setTimeout(() => {
