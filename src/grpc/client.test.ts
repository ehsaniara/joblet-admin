...
describe('JobletGrpcClient - Proto Service Coverage', () => {
  ...
  beforeEach(() => {
    ...
    mockJobServiceClient = {
      ...
      RunWorkflow: vi.fn((req, callback) => callback(null, { workflowId: 'wf-123' })),
      GetWorkflowStatus: vi.fn((req, callback) => callback(null, { status: 'RUNNING' })),
      ListWorkflows: vi.fn((req, callback) => callback(null, { workflows: [] })),
      GetWorkflowJobs: vi.fn((req, callback) => callback(null, { jobs: [] })),
    };
  ...
  describe('JobService - All Methods', () => {
    ...
    it('should have RunWorkflow method', () => {
      expect(mockJobServiceClient.RunWorkflow).toBeDefined();
      expect(typeof mockJobServiceClient.RunWorkflow).toBe('function');
    });

    it('should have GetWorkflowStatus method', () => {
      expect(mockJobServiceClient.GetWorkflowStatus).toBeDefined();
      expect(typeof mockJobServiceClient.GetWorkflowStatus).toBe('function');
    });

    it('should have ListWorkflows method', () => {
      expect(mockJobServiceClient.ListWorkflows).toBeDefined();
      expect(typeof mockJobServiceClient.ListWorkflows).toBe('function');
    });

    it('should have GetWorkflowJobs method', () => {
      expect(mockJobServiceClient.GetWorkflowJobs).toBeDefined();
      expect(typeof mockJobServiceClient.GetWorkflowJobs).toBe('function');
    });
  });
  ...
  describe('Method Count Validation', () => {
    it('JobService should have exactly 15 methods', () => {
